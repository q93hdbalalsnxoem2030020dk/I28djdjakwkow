...
local function setupSounds(car)
    ...
    sounds.engine.SoundId = "rbxassetid://9120306953"
    ...
    sounds.supercharger.PlaybackSpeed = 0.8
    sounds.supercharger.Looped = false
    sounds.supercharger.Parent = soundPart
    
    if engineActive then
        local function playSoundContinuously(sound, startOffset)
            local function restartSound()
        ...
        playSoundContinuously(sounds.engine, 0.1)
        playSoundContinuously(sounds.supercharger, 0.05)
    end
end
